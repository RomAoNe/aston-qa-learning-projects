...
public class TriangleAreaCalculatorTest {
    ...
    public void calculateAreaWithValidSidesTest() {
    ...
    public void calculateAreaWithImpossibleTriangleTest() {
    ...
    public void calculateAreaWithNegativeSideTest() {
        assertThrows(IllegalArgumentException.class, () -> new TriangleAreaCalculator(-10, 9, 9));
    }

    @Test
    @DisplayName("Исключение, если одна или несколько сторон = 0")
    public void calculateAreaWithZeroSideTest() {
